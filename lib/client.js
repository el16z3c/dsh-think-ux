...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		/* TEST BUILD (0.1.3-test.3): diagnostics on to verify the passive-clamp
		 * no-arm fix, the intent-TTL zombie fix, and the new row glide
		 * (turn-rail navigation glides instead of snapping) in a real run.
		 * Official 0.1.3 ships false. */
		...
		/* TEST BUILD (0.1.3-test.2): mirror traces to the local sink
		 * (node trace-sink.cjs) for a disk log. Official 0.1.3 ships null. */
